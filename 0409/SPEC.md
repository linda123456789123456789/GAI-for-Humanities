...
- **背景圖片**:
  - 使用高品質情境圖片（來自 Unsplash）
  - 全螢幕背景，固定定位，覆蓋整個視窗
  - 半透明黑色遮罩（opacity 0.3）確保文字可讀性
  - 自適應不同螢幕尺寸（background-size: cover）
- **動畫效果**:
  - 卡片翻轉：3D flip animation (0.6s)
  - 按鈕 hover：scale + shadow
  - 分類切換：fade in/out
  - 背景切換：smooth transition (0.5s)
- **響應式**: 在桌面和平板上都能良好顯示
...
const categoryBackgrounds = {
  greetings: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=1920&q=80',
  transportation: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=1920&q=80',
  accommodation: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=1920&q=80'
};
```
